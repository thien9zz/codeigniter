	     ...
	     <div class="box-right">
			    ...
			    <div class="content-box">
			         ...
			         <div class="support">
                    <strong>ADMIN</strong>				
          <a rel="nofollow" href="s">
		    <img src="">
	      </a>
	      
	      <p>
	         <img style="margin-bottom:-3px" src="<?php echo public_url() ?>/site/images/phone.png">01687171464</p>
		  ...
		  <p>
			<a rel="nofollow" href="">
			     <img style="margin-bottom:-3px" src="<?php echo public_url() ?>/site/images/skype.png"> Skype:ongchuthien</a>
		</p>	
		</div>			        </div>
          </div>
       <!-- End Support -->
		 ...
		 <!-- The Fanpage -->
	       <div class="box-right">
			    ...
			    <div class="content-box">
			         ...
			         <iframe src="" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:300px;" allowtransparency="true">
	                 </iframe>
		 ...
		 <!-- The Fanpage -->
	       <div class="box-right">
			    ...
			    <div class="content-box">
					...
					</script><div id="histats_counter_420" style="display: block;"><a href="http://www.histats.com/viewstats/?sid=2138481&amp;ccid=401" target="_blank"><canvas id="histats_counter_420_canvas" width="119" height="81"></canvas></a></div></a>
